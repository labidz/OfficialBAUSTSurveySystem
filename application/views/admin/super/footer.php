        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 text-left">
                    <a  title='<?php eT("Developer"); ?>' href='raastechnology.com/labid/' target='_blank'>Developed By <br>Rohul Amin Labid<br>Dept:CSE<br>ID:200101093</a><br />
                    <?php if (Permission::model()->hasGlobalPermission('superadmin', 'read')) { ?> 
                        <a href="#modalSystemInformation" data-toggle="modal" title="<?=gT("Developer")?>"> 
                    <?php } ?>
                ...
                <div  class="col-xs-6 col-sm-4 text-center" >
                    <a href='https://baust.edu.bd' target="_blank">
                        <img alt='<?php printf(gT("Developed By Labid")); ?>' title='<?php printf(gT("BAUST")); ?>' src='<?php echo Yii::app()->getConfig('adminimageurl');?>donate.png'/>
                    </a>
                </div>

                <!-- Lime survey website -->
                <div class="col-xs-12 col-sm-4 text-right">
                    <a  title='<?php eT("Visit our website!"); ?>' href='https://baust.edu.bd' target='_blank'>Bangladesh Army University of Science and Technology</a><br />
                    <?php if (Permission::model()->hasGlobalPermission('superadmin', 'read')) { ?> 
                        <a href="#modalSystemInformation" data-toggle="modal" title="<?=gT("Developer")?>"> 
                    <?php } ?>
                    <?php echo "Saidpur";?>
